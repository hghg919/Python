...
result = floor(4.99) # 4.99의 내림한 값
print(result)
result = round(4.99) # 4.99의 반올림한 값
print(result)
result = ceil(4.99) # 4.99의 올림한 값
print(result)
result = ceil(3.14) # 3.14의 올림한 값
print(result)
...
# (형식) import 모듈명
# - 이 방법은 기능(함수) 앞에 기능이 속한 모듈명을 점(.)으로 연결해서 적어야 함
import math
...
# 실행 결과 : 0이상 1미만 사이의 수를 출력. 실행할 때마다 매번 다른 수 출력력
print(random())
print(random())
print(random())
